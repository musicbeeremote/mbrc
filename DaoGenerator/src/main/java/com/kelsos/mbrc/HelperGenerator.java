...
public class HelperGenerator {
  ...
  private void generateHelpers(Schema schema, Entity entity, File outDirFile) {
    ...
    root.put("id", id);
    id += INCREASE;
    generate(entity.getClassName() + "Helper", outDirFile, root, templateHelper,
        entity.getJavaPackage());
  }

  @SuppressWarnings("ResultOfMethodCallIgnored")
  private void generate(String className, File outDirFile, Map<String, Object> root,
      Template template, String javaPackage) {
    try {
  ...
  private void generateContentProvider(Schema schema, File outDirFile) {
    ...
    root.put("schema", schema);
    root.put("contentProvider", mProvider);
    generate(mProvider.getClassName(), outDirFile, root, templateContentProvider,
        mProvider.getJavaPackage());
  }
