...
class RemoteSessionManager
  ...
  constructor(
    ...
    init {
      ...
      mediaSession.setCallback(
        object : MediaSessionCompat.Callback() {
          ...
          override fun onPlay() {
            postAction(UserAction(Protocol.PLAYER_PLAY, true))
          }

          override fun onPause() {
            postAction(UserAction(Protocol.PLAYER_PAUSE, true))
          }
          ...
          override fun onSeekTo(pos: Long) {
            postAction(UserAction.Companion.create(Protocol.NOW_PLAYING_POSITION, pos))
          }
        },
      )
    }
    ...
    override fun onAudioFocusChange(focusChange: Int) {
      when (focusChange) {
        AudioManager.AUDIOFOCUS_GAIN -> Timber.Forest.d("gained")
        AudioManager.AUDIOFOCUS_LOSS, AudioManager.AUDIOFOCUS_LOSS_TRANSIENT -> Timber.Forest.d("transient loss")
        AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK -> Timber.Forest.d("Loss can duck")
      }
    }
