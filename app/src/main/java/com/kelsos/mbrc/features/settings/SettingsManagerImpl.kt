...
import com.kelsos.mbrc.common.utilities.RemoteUtils.versionCode
...
class SettingsManagerImpl(
  ...
  override val updates: UpdateChecking =
    object : UpdateChecking {
      ...
      override suspend fun setLastUpdated(
        lastChecked: Instant,
        required: Boolean,
      ) {
  ...
  override fun onlyAlbumArtists(): Flow<Boolean> = dataStore.data.map { it.user.displayAlbumArtist }
  ...
  override suspend fun shouldShowChangeLog(): Boolean {
    ...
    val currentVersion = versionCode.toLong()
