...
fun PlaylistScreen(
  ...
  val vm = koinViewModel<PlaylistViewModel>()
...
fun PlaylistScreen(
  ...
  Column(modifier = Modifier.fillMaxSize()) {
    ...
    val messages =
      mapOf(
        PlaylistUiMessages.RefreshSuccess to
          stringResource(id = R.string.playlists__refresh_success),
