...
@Inject constructor(private val service: NowPlayingService) : NowPlayingRepository {

  override fun getNowPlayingList(): Observable<List<QueueTrack>> = Observable.range(0,
      Integer.MAX_VALUE - 1)
