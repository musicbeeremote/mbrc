...
class LyricsAdapter
@Inject
constructor(context: Context) : RecyclerView.Adapter<LyricsAdapter.ViewHolder>() {
  private val data: MutableList<String>?
  private val robotoLight: Typeface

  init {
    robotoLight = Typeface.createFromAsset(context.assets, "fonts/roboto_light.ttf")
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    ...
    return ViewHolder(view, robotoLight)
  }

  /**
   * Called by RecyclerView to display the data at the specified position. This method
   * should load the contents of the [ViewHolder.itemView] to reflect the item at
   * the given position.
   *
   *
