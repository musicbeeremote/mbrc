...
@Inject
constructor(context: Context) : RecyclerView.Adapter<PlaylistTrackAdapter.PlaylistTrackViewHolder>() {
  ...
  fun setMenuItemSelectedListener(listener: MenuItemSelectedListener): PlaylistTrackAdapter {
