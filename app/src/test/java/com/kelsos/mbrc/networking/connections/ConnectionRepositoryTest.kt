...
class ConnectionRepositoryTest : KoinTest {
  ...
  @Test
  fun addMultipleNewSettings() = runTest {
  ...
  @Test
  fun addMultipleNewSettingsRemoveOne() = runTest {
  ...
  @Test
  fun deleteSingleDefault() = runTest {
    val (withId, withoutId) = generateSettings(1)
  ...
  @Test
  fun deleteFromMultipleDefaultFirst() = runTest {
    val (withId, withoutId) = generateSettings(4)
  ...
  @Test
  fun deleteFromMultipleDefaultSecond() = runTest {
    val (withId, withoutId) = generateSettings(4)
  ...
  @Test
  fun deleteFromMultipleDefaultLast() = runTest {
    val (withId, withoutId) = generateSettings(4)
  ...
  @Test
  fun deleteFromMultipleNonDefault() = runTest {
    val (withId, withoutId) = generateSettings(4)
