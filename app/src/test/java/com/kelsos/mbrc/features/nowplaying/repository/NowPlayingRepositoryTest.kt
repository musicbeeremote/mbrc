...
class NowPlayingRepositoryTest : KoinTest {
  ...
  @Test
  fun `it should be initially empty`() =
    runTest {
  ...
  @Test
  fun `user moves track from position 1 to position 5`() =
    runTest {
  ...
  @Test
  fun `user moves track from position 6 to position 1`() =
    runTest {
      coEvery { apiBase.getAllPages(Protocol.NowPlayingList, NowPlayingDto::class, any()) } answers
        {
          mockApi(20) {
  ...
  @Test
  fun `user search should return filtered results`() =
    runTest {
      coEvery { apiBase.getAllPages(Protocol.NowPlayingList, NowPlayingDto::class, any()) } answers
        {
          mockApi(20) {
  ...
  @Test
  fun `updated items should keep the same ids`() =
    runTest {
      coEvery { apiBase.getAllPages(Protocol.NowPlayingList, NowPlayingDto::class, any()) } answers
        {
          mockApi(5) {
  ...
  @Test
  fun `search should return -1 if item is not found`() =
    runTest {
      coEvery { apiBase.getAllPages(Protocol.NowPlayingList, NowPlayingDto::class, any()) } answers
        {
          mockApi(5) {
  ...
  @Test
  fun `search should return the position if item is found`() =
    runTest {
      coEvery { apiBase.getAllPages(Protocol.NowPlayingList, NowPlayingDto::class, any()) } answers
        {
          mockApi(5) {
