...
public class UserInputEvent
{
	...
	public static final String RequestNowPlayingPlayTrack = "RequestNowPlayingPlayTrack";
	public static final String RequestNowPlayingRemoveTrack = "RequestNowPlayingRemoveTrack";
