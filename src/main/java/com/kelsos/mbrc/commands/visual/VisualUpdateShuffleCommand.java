...
public class VisualUpdateShuffleCommand implements ICommand
{
	@Inject
	...
	public void execute(IEvent e)
	{
		if (afProvider.getActiveFragment(MainFragment.class) != null)
		{
			...
			cActivity.runOnUiThread(new Runnable()
			{
				...
				public void run()
				{
					((MainFragment) afProvider.getActiveFragment(MainFragment.class)).updateShuffleButtonState(model.getIsShuffleButtonActive());
				}
			});
		}
	}
