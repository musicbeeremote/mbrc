 ...
 * </div>
 */
public class RoboAppCompatActivity extends RoboFragmentActivity
  ...
  @Override public final boolean onMenuItemSelected(int featureId, android.view.MenuItem item) {
   ...
   */
  @CallSuper public void onSupportActionModeStarted(ActionMode mode) {
  }
   ...
   */
  @CallSuper public void onSupportActionModeFinished(ActionMode mode) {
  }
   ...
   */
  @Nullable @Override public ActionMode onWindowStartingSupportActionMode(ActionMode.Callback callback) {
    return null;
  }
   ...
   */
  @Deprecated public void setSupportProgressBarVisibility(boolean visible) {
  }
   ...
   * by using {@link android.support.v4.app.TaskStackBuilder} or another similar mechanism to perform up
   * navigation.</p>
   *
  ...
  @Nullable @Override public ActionBarDrawerToggle.Delegate getDrawerToggleDelegate() {
