...
class TrackAdapter
@Inject constructor(context: Context) : RecyclerView.Adapter<TrackAdapter.ViewHolder>() {
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    if (cover != null) {
      ...
      Picasso.with(holder.itemView.context).load(image).placeholder(R.drawable.ic_image_no_cover).fit().centerCrop().tag(
          holder.itemView.context).into(holder.cover)
    }
